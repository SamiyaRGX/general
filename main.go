...
func main() {
	// PaaS ها پورت رو خودشون با متغیر PORT میدن - Render, Koyeb, Railway, Zeabur
	...
	go startProxy(publicPort, panelPort, vlessPort, vlessPrefix, subPort, subPrefix)
...
func startProxy(publicPort, panelPort, vlessPort, vlessPrefix, subPort, subPrefix string) {
